<div class="bitpay-pairing bitpay-pairing--%s">
	...
	<button class="bitpay-pairing__find ui-button-text">Find</button>
	<div class="bitpay-pairing__help">Get a pairing code: <a href="https://globee.com/api-tokens" class="bitpay-pairing__link">https://globee.com/api-tokens</a></div>
</div>